...
class SpatQuadranion(Quaternion):
    def rotate(self, p):
    ...
    def __str__(self):
        return f'TooliqaQuaternion{self.w, self.x, self.y, self.z}'
...
def getQuaternion(v1, v2):
    ...
    return SpatQuadranion(axis=cross, angle=angle1)
...
def get_quaternion_from_euler(roll, pitch, yaw):
  ...
  return SpatQuadranion([qw, qx, qy, qz])
